...
| 操作 | 说明 |
| --- | --- |
| 鼠标移到手牌上 | 手牌平时只在屏幕底部露出一角，悬停时自动抬升并展开完整卡面 |
| 点击手牌 | 打出卡牌；需要目标的卡牌会提示「请选择目标」，再次点击同一张可取消 |
| 点击目标 | 为法术/战吼指定随从或英雄 |
| 点击自己的随从 → 点击敌方单位 | 发起攻击 |
...
界面自上而下依次为：对手英雄与技能、对手随从排、我方随从排、我方英雄与技能，最底部是手牌区。手牌默认收起为一条窄边，只显示费用与名称，鼠标悬停或选中时才抬升放大展开，因此不会遮挡英雄血量和技能按钮。
